...
fs.writeFileSync(path.join(__dirname, '../dist/qix-hierarchy-select.js'), supernovaCode);
console.log('Built dist/qix-hierarchy-select.js (' + supernovaCode.length + ' bytes)');
